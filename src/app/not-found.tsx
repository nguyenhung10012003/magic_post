  ...
  return (
    <>
      ...
      <div className="h-screen w-screen flex items-center">
        <div className=" w-full flex flex-col md:flex-row items-center justify-center px-5 text-textColor1">
          <div className="max-w-md">
            ...
            <p className="mb-8">
              Đừng lo lắng, bạn có thể tìm thấy nhiều điều thú vị khác ở trang chủ
            </p>
            <button
