    ...
    <li className="relative">
      ...
      >
        <div className="px-4.5 py-3">
          <h5 className=" text-lg font-semibold text-black">Notification</h5>
        </div>
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          ...
          <li>
            ...
            >
              ...
              <p className="text-xs text-bodydark2">24 Feb, 2025</p>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <p className="text-xs text-bodydark2">04 Jan, 2025</p>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <p className="text-xs text-bodydark2">01 Dec, 2024</p>
            </Link>
          </li>
        </ul>
      </div>
